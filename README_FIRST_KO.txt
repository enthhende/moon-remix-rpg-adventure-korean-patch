...
2. xdelta3 3.1.0 실행 파일을 받아 이 폴더 또는 tools 폴더에 넣습니다.
   https://github.com/jmacd/xdelta-gpl/releases/tag/v3.1.0

3. 운영체제에 맞는 파일을 실행합니다.
   Windows : apply_patch_windows.bat
   macOS   : apply_patch_macos.command
   Linux   : apply_patch_linux.sh

4. 요청이 나오면 원본 Rev 1 BIN과 CUE를 지정합니다.

5. 성공하면 원본 옆의 Moon_Korean_v1.0 폴더가 만들어집니다.
