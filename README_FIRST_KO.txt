moon: Remix RPG Adventure PS1 한국어 패치 v1.1
================================================
...
1. Moon_PS1_Korean_Patch_v1.1_Windows_Portable.zip을 완전히 풉니다.
...
4. 성공하면 원본 옆의 Moon_Korean_v1.1 폴더가 만들어집니다.
   에뮬레이터에서는 그 폴더의 CUE 파일을 여세요.

macOS / Linux
-------------

Moon_PS1_Korean_Patch_v1.1.zip을 받고 Python 3과 xdelta3 3.2.0을
준비한 뒤 다음 파일을 실행합니다.
...
- 일반 메모리카드 저장은 호환됩니다.
- Mednafen과 DuckStation에서 확인됐으며, PS2 실기 POPS 환경에서도 외부
  사용자의 구동 확인이 있습니다. 원본 PlayStation 본체는 미검증입니다.
